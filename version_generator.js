...
var manifest = {
    packageUrl: `${commonUrl}${subPackage}/`, //包存储的远程服务器地址
    zhName:subPackage, //子包名
...
var dest = `./assets/Manifest/${subPackage}`;  //生成的文件放在哪里
var src = './build/jsb-default/'; //src 放在build下
